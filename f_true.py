...
cases = [
    formatter.format_to_array(
        '000000000000001000011000000100010100000001011001000000101000010000000100000000000000000000000000001000000000001101001000010110111000001010111110001010100111000001000101001000000(42)')
